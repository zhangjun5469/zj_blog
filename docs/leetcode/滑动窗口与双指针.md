...
1. [盛最多水的容器](https://leetcode.cn/problems/container-with-most-water/solutions/)
```cpp
class Solution {
public:
...
2. [两数之和 II - 输入有序数组](https://leetcode.cn/problems/two-sum-ii-input-array-is-sorted/solutions/)
```cpp
class Solution {
public:
...
```
3. [三数之和](https://leetcode.cn/problems/3sum/solutions/)
```cpp
class Solution {
public:
...
```
4. [验证回文串](https://leetcode.cn/problems/valid-palindrome/solutions/)
```cpp
class Solution {
public:
...
```
5. [反转字符串](https://leetcode.cn/problems/reverse-string/solutions/)
```cpp
class Solution {
public:
...
```
6. [反转字符串中的元音字母](https://leetcode.cn/problems/reverse-vowels-of-a-string/solutions/)
```cpp
class Solution {
public:
    ...
    bool check(char& c)
    {
        ...
        return lc=='a' || lc=='e' || lc=='u' || lc=='i' || lc=='o';
    }
};
```
## 练习
1. [最接近的三数之和](https://leetcode.cn/problems/3sum-closest/solutions/)
```cpp
class Solution {
public:
    int threeSumClosest(vector<int>& nums, int target) {
        ...
        for(int i=0; i<n; ++i)
        {
            ...
            {
                int sum = nums[l] + nums[r];
                if(abs(sum-twoSum)< minDiff)
                {
                    minDiff = abs(sum-twoSum);
                    ans = nums[i] + sum;
                }
                else if(sum>twoSum)
                {
...
```
2. [四数之和](https://leetcode.cn/problems/4sum/solutions/)
```cpp
class Solution {
public:
...
```
3. [接雨水](https://leetcode.cn/problems/trapping-rain-water/solutions/)
```cpp
class Solution {
public:
...
```
4. [找到 K 个最接近的元素](https://leetcode.cn/problems/find-k-closest-elements/solutions/)
```cpp
class Solution {
public:
...
```
5. [较小的三数之和](https://leetcode.cn/problems/3sum-smaller/solutions/)
```cpp
class Solution {
public:
...
```
6. [有序转化数组](https://leetcode.cn/problems/sort-transformed-array/solutions/)
```cpp
class Solution {
public:
    vector<int> sortTransformedArray(vector<int>& nums, int a, int b, int c) {
        ...
        if(a==0)
        {
            ...
            if(b<0) reverse(ans.begin(), ans.end());
            return ans;
        }
...
```
7. [比较含退格的字符串](https://leetcode.cn/problems/backspace-string-compare/solutions/)
```cpp
class Solution {
public:
    bool backspaceCompare(string s, string t) {
       ...
       return s.substr(0, sj) == t.substr(0, tj);
    }
};
```
8.[数组中的最长山脉](https://leetcode.cn/problems/longest-mountain-in-array/solutions/)
```cpp
class Solution {
public:
    int longestMountain(vector<int>& arr) {
        ...
        while(i<n)
        {
            if(i<n-1 && arr[i]<arr[i+1]) // 以增区间开始
            {
                start = i;
                while(i<n-1 && arr[i]<arr[i+1]) // 耗尽增区间
                {
                    i++;
                }
                if(i<n-1 && arr[i]>arr[i+1]) // 以减区间邻接
                {
                    while(i<n-1 && arr[i]>arr[i+1]) // 耗尽减区间
                    {
                        i++;
                    }
                    end = i;
...
```
9. [救生艇](https://leetcode.cn/problems/boats-to-save-people/solutions/)
```cpp
class Solution {
public:
...
```
10. [长按键入](https://leetcode.cn/problems/long-pressed-name/solutions/)
```cpp
class Solution {
public:
    bool isLongPressedName(string name, string typed) {
        ...
        while(i1<n1 && i2<n2)
        {
            if(name[i1]!=typed[i2]) return false;
            int ti1 = i1+1;
            int ti2 = i2+1;
            while(ti1<n1 && name[ti1-1]==name[ti1]) ti1++;
            while(ti2<n2 && typed[ti2-1]==typed[ti2]) ti2++;
            if(ti1-i1>ti2-i2) return false;
            i1 = ti1;
            i2 = ti2;
        }
...
```
11. [有序数组的平方](https://leetcode.cn/problems/squares-of-a-sorted-array/solutions/)
```cpp
class Solution {
public:
...
```
12. [小于 K 的两数之和](https://leetcode.cn/problems/two-sum-less-than-k/solutions/)
```cpp
class Solution {
public:
...
```
13.[安排会议日程](https://leetcode.cn/problems/meeting-scheduler/solutions/)
```cpp
class Solution {
public:
    vector<int> minAvailableDuration(vector<vector<int>>& slots1, vector<vector<int>>& slots2, int duration) {
        ...
        while(p1<n1 && p2<n2)
        {
            int availStart = max(slots1[p1][0], slots2[p2][0]);
            int availEnd = min(slots1[p1][1], slots2[p2][1]);
            if(availEnd-availStart >= duration)
            {
                return {availStart, availStart+duration};
            }
